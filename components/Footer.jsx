        ...
        <footer className={styles.footercontainermain} style={{ backgroundColor: "#0D3344" }}>
            ...
            <div className="container mt-4 ">
                ...
                <div className="d-flex flex-wrap justify-content-center mt-3 mb-3">
                    <div className="p-2"><img src="/images/social/instagram.svg" style={{width:"2em",marginRight:".5rem"}} alt="" /></div>
                    <div className="p-2"><img src="/images/social/linkedin.svg" style={{width:"2em",marginRight:".5rem"}} alt="" /></div>
                    <div className="p-2"><img src="/images/social/telegram.svg" style={{width:"2em",marginRight:".5rem"}} alt="" /></div>
                    <div className="p-2"><img src="/images/social/twitter.svg" style={{width:"2em",marginRight:".5rem"}} alt="" /></div>
