const TermsConditions = () => {
    return (
        <div className="container mt-4 mb-4">
            ...
            <p>Please read the following terms and conditions carefully as it sets out the terms of a legally binding agreement between you (the reader) and Business Standard Private Limited.

            <p>1. Introduction
            This following sets out the terms and conditions on which you may use the content on
            business-standard.com website, business-standard.coms mobile browser site, Business Standard instore Applications and other digital publishing services (www.smartinvestor.in, www.bshindi.com and www.bsmotoring,com) owned by Business Standard Private Limited, all the services herein will be referred to as Business Standard Content Services.
            </p>
            <p>
            ...
            Each registration is for a single user only. On registration, you will choose a user name and passwordID. You are not allowed to share your ID or give access to your account to anyone else. Business Standard Premium subscription does not allow multiple users on a network or within an organization to use the same ID.
            ...
            If you provide Business Standard with an email address that will result in any messages Business Standard may send you being sent to you via a network or device operated or owned by a third party (e.g. your employer or college) then you promise that you are entitled to receive those messages. To ensure emails land in your inbox, you will add the bsmail receipt id to your safe list. You also agree that Business Standard may stop sending messages to you without notifying you.

            Important - Kindly note

            A When you participate and choose to subscribe to joint content subscription offers that Business Standard partners with; your email id, access password and entered personal information will be shared with the participating content partner brand via an encrypted server to server protocol. This sharing is to facilitate your seamless access across the partner brands platform. Once you login to the partner brands platform, specific terms and privacy policies of the partner brand mentioned on its website will apply.
            ...
            You may notify us of your wish to cancel your subscription by contacting our Customer Services team at assist@bsmail.in. To enable us cancel your subscription please provide us with your complete name (as was in the subscription order form), Email address and Contact number clearly written out.
            ...
            * Not post or otherwise publish any UGC unrelated to the Forum or the Forums topic.
            ...
            * Comply with the guidelines for commenting set out in our Commenting FAQ.
            ...
            You agree that if we are in breach of these terms and conditions, we will only be responsible to you for any damages that you incur arising out of your use of Business-standard.com (to the extent that Business Standards liability is not otherwise excluded by this section 9) as follows:
            ...
            Business Standard will only be responsible for loss or damage you suffer which is the reasonably foreseeable result of Business-Standards breach of a legal duty of care owed to you.
            ...
            Business Standards liability will not be limited in the case of death or personal injury directly caused by Business Standards negligence in those countries where it is unlawful for Business Standard to seek to exclude such liability.
